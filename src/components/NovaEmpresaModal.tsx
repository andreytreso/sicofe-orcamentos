...
export function NovaEmpresaModal({ open, onOpenChange }: NovaEmpresaModalProps) {
  const { insert: insertCompany, isInserting } = useSupabaseTable('companies');
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="col-span-2">
                ...
                />
                {errors.endereco_rua && (
                  <p className="text-sm text-destructive mt-1">{errors.endereco_rua.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.endereco_numero && (
                  <p className="text-sm text-destructive mt-1">{errors.endereco_numero.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                {errors.endereco_cidade && (
                  <p className="text-sm text-destructive mt-1">{errors.endereco_cidade.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.endereco_estado && (
                  <p className="text-sm text-destructive mt-1">{errors.endereco_estado.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.endereco_cep && (
                  <p className="text-sm text-destructive mt-1">{errors.endereco_cep.message}</p>
                )}
              </div>
            </div>
          </div>
