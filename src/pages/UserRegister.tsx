          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.role} onValueChange={(value) => handleInputChange('role', value)}>
                <SelectTrigger className="border-gray-300 focus:ring-0 focus:border-gray-300 focus-visible:ring-0 focus-visible:ring-offset-0 data-[state=open]:ring-0 data-[state=open]:border-gray-300" style={{ backgroundColor: '#EEF4FF' }} aria-invalid={!!errors.role}>
            ...
            <Button
              ...
              className="w-full bg-[#0047FF] hover:bg-blue-600 text-white rounded-lg py-2 disabled:opacity-50"
            >
              {isLoading ? (
                <>
